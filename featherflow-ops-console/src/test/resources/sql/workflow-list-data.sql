...
values
    ('wf-running-0001', 'biz-1001', 'order:1001', 'orderWorkflow', '10.9.8.7:host-a:1234:seed', timestamp '2026-04-01 09:00:00', timestamp '2026-04-01 09:08:00', '{"orderId":"1001"}', 'RUNNING'),
    ('wf-terminated-01', 'biz-1002', 'refund:1002', 'refundWorkflow', '10.9.8.7:host-b:1234:seed', timestamp '2026-04-01 09:01:00', timestamp '2026-04-01 09:10:00', '{"orderId":"1002"}', 'TERMINATED');
