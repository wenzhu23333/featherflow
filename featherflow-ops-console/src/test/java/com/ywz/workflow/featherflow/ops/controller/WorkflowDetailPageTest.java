...
class WorkflowDetailPageTest {
    ...
    void shouldRenderExecutedActivityFlowOverviewOnDetailPage() throws Exception {
        ...
        assertThat(page).doesNotContain("id=\"activity-flow-node-3\"");
        assertThat(page).contains("data-activity-name=\"validateOrder\"");
        assertThat(page).contains("data-activity-name=\"chargePayment\"");
        assertThat(page).doesNotContain("data-activity-name=\"captureFunds\"");
        ...
        assertThat(page).doesNotContain("未执行");
        assertThat(page).doesNotContain("暂无执行记录");
    ...
    void shouldRenderExecutedActivityFlowOverviewInTimelineFragment() throws Exception {
        ...
        assertThat(fragment).doesNotContain("data-activity-name=\"captureFunds\"");
        ...
        assertThat(fragment).doesNotContain("未执行");
        assertThat(fragment).doesNotContain("暂无执行记录");
        assertThat(fragment).doesNotContain("<html");
    }
